...
(function() {
    ...
    const CONFIG = {
        ...
        fullSaveDelay: 1000 // 전체 저장 시 각 채팅방 API 호출 사이의 딜레이 (ms)
    };
    ...
    const apiHandler = {
        ...
        async fetchAllMessages(chatroomId, accessToken) {
            ...
            return (data.data.list || []).reverse(); // 순서를 오래된 메시지 -> 최신으로 변경
        }
    };
        ...
        generateFullHtml(allChatsData) {
            ...
            const embeddedScript = `
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    if (allChatsData.length > 0) renderChat(0);
                });
            `;
